...
from cyberclaw.cli import commands
...
def mock_prompt_session():
    ...
    with patch("cyberclaw.cli.commands._PROMPT_SESSION", mock_session), \
         patch("cyberclaw.cli.commands.patch_stdout"):
        yield mock_session
...
def test_init_prompt_session_creates_session():
    ...
    with patch("cyberclaw.cli.commands.PromptSession") as MockSession, \
         patch("cyberclaw.cli.commands.FileHistory") as MockHistory, \
