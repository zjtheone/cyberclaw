...
from cyberclaw.utils.helpers import ensure_dir, estimate_message_tokens, estimate_prompt_tokens_chain
...
class MemoryStore:
    ...
    def __init__(self, workspace: Path, memory_search_config: Optional[Dict[str, Any]] = None):
        ...
        if memory_search_config and memory_search_config.get("enabled", False):
            try:
                from cyberclaw.agent.memory_vector import VectorMemoryAdapter
