...
try:
    ...
    raise ImportError(
        "Matrix dependencies not installed. Run: pip install cyberclaw-ai[matrix]"
    ) from e

from cyberclaw.bus.events import OutboundMessage
from cyberclaw.channels.base import BaseChannel
from cyberclaw.config.paths import get_data_dir, get_media_dir
from cyberclaw.utils.helpers import safe_filename
